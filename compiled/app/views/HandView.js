...
(function() {
  ...
  window.HandView = (function(_super) {
    ...
    HandView.prototype.render = function() {
      ...
      scoreText = this.collection.scores().length > 1 ? this.collection.scores()[0] + " or " + this.collection.scores()[1] : this.collection.scores()[0];
      return this.$('.score').text(scoreText);
    };
